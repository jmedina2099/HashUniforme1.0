 ...
 *
 */ 
public class AzraelX3 implements FuncionHash {
	...
	private static final String EMPTY_STRING_1_IT = 
			"763987f798066c2629c5d7a96ff385547d6d56b6ddddb7e0970874d5d9fa6dd86f37669c100ac37c2cf8ba71e82313ade00f1cbdb2936bdffb97b29b031cfab83db144e40a9a4476e9bc06218b86cede24a0bba5e15f9cb1";

	private static final String EMPTY_STRING_2_IT = 
			"4302728eabe13fbc5fd443295fe71e83ea49070e671e2579285bc2a4f5654567d26306a0dae44739577a6ad21b7e0e3d17626a9a11639160a83dd1bbc11f66847468b06671e8c42a690651f93cdc73ac29b3581707d62c11";
	 ...
	 *
	 */
	public AzraelX3( int numIterations ) {
	...
	public byte[] getHashEval( byte[] input ) {
		...
		sumaAnt1 += evaluaFuncBool( sumaAnt1,sumaAnt1,sumaAnt1,sumaAnt1,sumaAnt1) + IV3;
		sumaAnt2 += evaluaFuncBool( sumaAnt2,sumaAnt2,sumaAnt2,sumaAnt2,sumaAnt2) + IV5;
		sumaAnt3 += evaluaFuncBool( sumaAnt3,sumaAnt3,sumaAnt3,sumaAnt3,sumaAnt3) + IV7;
		sumaAnt4 += evaluaFuncBool( sumaAnt4,sumaAnt4,sumaAnt4,sumaAnt4,sumaAnt4) + IV9;
		sumaAnt5 += evaluaFuncBool( sumaAnt5,sumaAnt5,sumaAnt5,sumaAnt5,sumaAnt5) + IV1;
		sumaAnt6 += evaluaFuncBool( sumaAnt6,sumaAnt6,sumaAnt6,sumaAnt6,sumaAnt6) + IV2;
		sumaAnt7 += evaluaFuncBool( sumaAnt7,sumaAnt7,sumaAnt7,sumaAnt7,sumaAnt7) + IV4;
		sumaAnt8 += evaluaFuncBool( sumaAnt8,sumaAnt8,sumaAnt8,sumaAnt8,sumaAnt8) + IV6;
	...
	public String toString() {
		return "AzraelX3 "+numIterations+"x";
	}
	...
	public static void main(String[] args) {
		...
		int tope = 2;
		AzraelX3 hash = new AzraelX3(tope);
	...
	public static String getHash( String input, AzraelX3 hash ) {
